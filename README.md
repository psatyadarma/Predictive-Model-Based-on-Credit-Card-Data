# Predictive-Model-based-on-credit-card-data
...
This data employed a binary variable, default payment (Yes = 1, No = 0), as the response variable. It contains the following 23 variables as explanatory variables:
